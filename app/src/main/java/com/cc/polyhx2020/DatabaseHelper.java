...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insert (String email, String password, String firstName, String lastName, String dateOfBirth, String phoneNumber, String certificationID){
        ...
        contentValues.put("certificationID", certificationID);
